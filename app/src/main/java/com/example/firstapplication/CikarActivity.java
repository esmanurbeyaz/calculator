...
public class CikarActivity extends AppCompatActivity {
    ...
    Button btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btn0, btnPoint, btnClear, btnDel, btnMinus, btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMinus = (Button) findViewById(R.id.divide);
        ...
        btnMinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    txtResault.setText(formattedCikar);
